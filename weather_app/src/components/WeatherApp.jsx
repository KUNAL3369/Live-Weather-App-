...
import loadingGif from '../assets/images/loading.gif'
 ...
 const WeatherApp = () => {
    ...
    const api_key = '9c675595b7bc781c14065f667223ce0c'


    useEffect(() => {
  const fetchDefultWeather = async()=>{
    setLoading(true)
  ...
  fetchDefultWeather ()
    ...
    const day = daysoOfWeek[date.getDay()];
    const month = months[date.getMonth()];
    const today = `${day}, ${date.getDate()} ${month}`;
        ...
        <div className='weather-app' style={{backgroundImage:backgroundImage && backgroundImage.replace ? backgroundImage.replace('to right','to top'):null}}>
            <div className='search'>
                ...
                <div className='search-bar'>
                    <input type="text" placeholder='Enter Location Here' value={location} onChange={handleInputChange} onKeyDown={handlekeyDown} />
